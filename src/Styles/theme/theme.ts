...
import { IThemeDefault, IBackgroundImage, IAniFadeUp } from './theme.types';

const theme: IThemeDefault = {
  webWidth: '1200px',
...
// background
export const backgroundImage = css<IBackgroundImage>`
...
export const aniFadeUp = css<IAniFadeUp>`
  visibility: hidden;
  opacity: 0;
